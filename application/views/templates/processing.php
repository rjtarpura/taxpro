...
<head>
    ...
    <title>Set up a new password for Professional Therapy Solution</title>
</head>
<body
...
<span class="preheader"
      style="box-sizing: border-box; display: none !important; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; mso-hide: all; opacity: 0; overflow: hidden; visibility: hidden;">Use this link to reset your password. The link is only valid for 24 hours.</span>
                                ...
                                <td class="content-cell"
                                  ...
                                  <p style="box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;"
                                       align="left"> <strong
											...
											<?php echo $client_details['first_name'].' '.$client_details['last_name']; ?></strong>,
                                            <br/>
                                            <p>
                                                Welcome to taxpro
                                            </p>
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p class="sub align-center"
                                       ...
                                       align="center">© <?php echo date('Y'); ?> <?php echo $website_title;?>. All
                                        rights reserved.</p>
                                    <p class="sub align-center"
                                       style="box-sizing: border-box; color: #AEAEAE; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;"
                                       align="center">
